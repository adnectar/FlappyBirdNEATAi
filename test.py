...
GEN = 0
highest_score = 0  # Add a global variable for the highest score
...
def draw_window(win, birds, pipes, base, score, gen):
    global highest_score  # Declare the global variable
    ...
    win.blit(text, (WIN_WIDTH - 90 - text.get_width(), 10))
    ...
    highest_text = STAT_FONT.render("Highest: " + str(highest_score), 1, (255, 255, 255))
    win.blit(highest_text, (WIN_WIDTH - 150 - text.get_width(), 60))
...
def main(genomes, config):
    ...
    while run:
        ...
        if add_pipe:
            score += 1
            if score > highest_score:  # Update the highest score if the current score is higher
                highest_score = score
            for g in ge:
                g.fitness += 5
